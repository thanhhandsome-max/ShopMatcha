...
export default function Header() {
  ...
  return (
    <>
      {/* Announcement Bar */}
      <div className="bg-[#2D5016] text-white text-center py-2 text-xs tracking-widest font-medium">
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center gap-3">
              ...
              {user ? (
                ...
                <Link href="/auth/login" className="p-2 hover:text-[#2D5016] transition-colors hidden sm:block" title="Đăng nhập">
                  <User size={18} />
                </Link>
              )}
